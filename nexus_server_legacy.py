...
# compatibility for v2 UI - Added AFTER app init
@app.post("/start")
async def start_compat(request: Request):
    return JSONResponse({"message": "Compatibility Mode"}, headers={"X-Response": "Welcome. I am ready."})
